...
/*   Updated: 2025/11/21 00:01:37 by imutavdz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
heses
*/
...
// 		if (calc != 0)
// 			return (0);
// 		return (is_bal_paired(str, i + 1, j - 1) && is_bal_paired(str, j, len));
// 	}
// 	return (is_bal_paired(str, i + 1, len));
// }
...
// 	if (argc != 2)
// 		return (1);
// 	if (is_bal_paired(argv[1], 0, strlen(argv[1])))
// 		printf("ok");
// 	else
// 		printf("Err");
// 	return (0);
